...
/////////////////
const  BotName  = 'YD BOT☄' ;
const   instagram   =   'https://instagram.com/ydbahtiar' ;
 telegram    const   =    'https://t.me/'ydbahtiar ;
...
samb . pada ( 'pengguna-kehadiran-pembaruan' , json   =>   konsol .log ( json .id + 'keberadaan adalah = > ' + json .type ) ) || konsol . log ( 'Bot dari ig:@ydbahtiar' )         
